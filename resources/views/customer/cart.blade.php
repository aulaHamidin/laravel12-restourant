            ...
            @else
                ...
                <div class="d-flex justify-content-end mb-4">
                    <a href="{{ route('cart.clear') }}" class="btn btn-danger text-uppercase"
                        onclick="return confirm('Apakah Anda yakin ingin mengosongkan keranjang?')">Kosongkan
                        Keranjang</a>
                </div>
...
@section('script')
    <script>
        function updateQuantity(itemId, change) {
            ...
            if (newQty <= 0) {
                if (confirm('Jumlah tidak boleh kurang dari 1. Apakah Anda ingin menghapus item ini?')) {

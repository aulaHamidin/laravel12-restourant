        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Ubah Item</h3>
                    <p class="text-subtitle text-muted">Silahkan Isi Data Item Yang Ingin Diubah</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <textarea name="description" id="description" rows="3"
                                            ...
                                            placeholder="Masukkan deskripsi produk">{{ old('description', $item->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <select name="category_id" id="category_id"
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ old('category_id') == $category->id ? 'selected' : '' }} {{$item->category_id == $category->id ? 'selected' : ''}}>
                                                    {{ $category->cat_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        @if ($item->image)
                                            <div class="my-2">
                                                <img src="{{ asset('assets/img_item/' . $item->image) }}" alt="{{ $item->item_name }}"
                                                class="img-fluid rounded mb-2" style="width: 100px; height: 100px; object-fit: cover;">
                                            </div>
                                        @else
